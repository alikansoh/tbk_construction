...
const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Transform your kitchen into a modern, functional space that adds value to your home.",
  ...
  },
  {
    ...
    description:
      "Expert installation for carpets, hardwood, tile, laminate, and luxury vinyl.",
  ...
  },
  {
    ...
    description:
      "Licensed electricians for safe, code-compliant electrical installations and repairs.",
  ...
  },
  {
    ...
    title: "Plumbing",
    description:
      "Professional plumbing services from routine maintenance to major installations.",
  ...
  },
  {
    ...
    description:
      "Interior and exterior painting services that bring new life to your property.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10">
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 0.6, ease: cubicEasing }}
          >
            From small repairs to complete renovations, our skilled
            professionals deliver exceptional results.
          </motion.p>
        </motion.div>
          ...
          {SERVICES.map((service, index) => (
            <Link key={service.title} href={service.link}>
              <motion.div
                ...
                whileHover={{
                  y: -8,
                  transition: { duration: 0.25, ease: cubicEasing },
                }}
                  ...
                  <div className="p-6">
                    ...
                    <ul className="space-y-2 mb-6">
                      {service.features.map((f) => (
                        ...
                        >
                          <div className="w-5 h-5 flex items-center justify-center rounded-md bg-orange-500/30 border border-orange-400/30 mr-3">
                            ✓
                          </div>
                          {f}
                        </li>
                    ...
                    <motion.div
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 text-white py-3 rounded-xl text-center font-bold shadow-[0_0_25px_rgba(249,115,22,0.4)]"
                    >
                      Learn More →
                    </motion.div>
                  </div>
